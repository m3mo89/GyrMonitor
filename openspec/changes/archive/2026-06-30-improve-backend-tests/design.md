...
2. Split tests by level and command.
...
3. Prefer dependency injection or overridable factories for controller e2e tests.
...
4. Keep repositories fake and deterministic in unit tests.
...
5. Validate HTTP contracts at controller boundaries.
