# Desktop UI Design System Specification

## Purpose

Define the shared visual design system for the desktop `.NET MAUI` client — semantic color brushes, spacing/typography tokens, and reusable card, badge, and empty-state styles — so feature pages present a consistent, theme-aware appearance instead of ad hoc literal styling, aligned with `knowledge-base/06-engineering/desktop/maui-desktop.md`.
