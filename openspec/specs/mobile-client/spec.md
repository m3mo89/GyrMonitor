...
Define the mobile `.NET MAUI` client used by field operators to authenticate, review alerts, and capture observations offline, syncing with the backend `offline-sync` capability, aligned with `knowledge-base/06-engineering/mobile/overview.md`.
